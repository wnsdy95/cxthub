...
Forks should use a distinct product name and clearly identify their changes.
Unmodified redistribution may retain factual package and command names where
required for compatibility, provided the distributor is clearly identified.
