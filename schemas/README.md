...
4. **R1 stability** — Do not make backward-incompatible changes to the fields, types, or required sets in `cir.schema.json` or `manifest.schema.json`. Adding fields also affects `"additionalProperties": false` and therefore requires team review.

## Related Documents

- Domain Entity Source of Truth: `docs/DATA-MODEL.md`
- Synchronization Protocol Source of Truth: `docs/SYNC-PROTOCOL.md`
- Architecture Contract: `docs/_ARCHITECTURE-R2.md`
- Cross-Compatibility Tool Vocabulary: `docs/CROSS-COMPAT.md`
