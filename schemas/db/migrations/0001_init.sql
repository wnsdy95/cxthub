...
-- Domain contract: docs/DATA-MODEL.md, docs/SYNC-PROTOCOL.md
...
COMMENT ON COLUMN snapshots.id IS 'ContentHash. Snapshot.ID = ContentHash(canonical_bytes(SessionDoc.CIR)). docs/SYNC-PROTOCOL.md §3.4.';
