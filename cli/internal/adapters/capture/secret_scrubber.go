...
// ScrubTier is a secret scrub strength tier (CAPTURE §5.3).
...
// Masking format: «redacted:<kind>» (CAPTURE §5.2).
...
// Scrub returns a new CIRDocument with sensitive information masked from the original (CAPTURE §5).
//
