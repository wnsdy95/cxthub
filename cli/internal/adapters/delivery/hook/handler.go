...
// emitBriefing consumes the current terminal's team context briefing (generated
// by git pull) and emits it as JSON to stdout via hookSpecificOutput.additionalContext.
