...
//
// session/memory adapter provides pure path utilities (no side effects). It consolidates path rules (RESEARCH-FINDINGS) for session files and memory files to reduce duplication.
package providerfs
