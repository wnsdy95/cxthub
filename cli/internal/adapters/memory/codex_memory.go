...
// CodexMemorySource reads Codex native memory from memories_1.sqlite stage1_outputs (_RECONCILIATION §B).
...
// CodexMemorySink writes a MemoryDigest to Codex AGENTS.md (_RECONCILIATION §B).
