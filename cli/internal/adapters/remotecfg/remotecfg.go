...
type fileConfig struct {
	...
	// CaptureDebounceSec is the debounce window (seconds) for hook Stop capture (CAPTURE §4.1).
...
// CaptureDebounce returns the debounce window for hook Stop capture (default 60s, CAPTURE §4.1).
