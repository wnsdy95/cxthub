...
// MemorizeService implements the Memorize inbound port as per the _RECONCILIATION section.
//
...
// Push carries the attached memory with the raw document (RECONCILIATION section E).
