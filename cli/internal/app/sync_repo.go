...
// push/pull authority operations are delegated to the central server REST (SYNC-PROTOCOL §3) via RemoteSync.
...
// Push uploads local snapshots/docs/refs to the central server (SYNC-PROTOCOL §3.2).
...
// Branch refs are not modified (hook path does not move server refs — same spirit as CAPTURE §2.5).
