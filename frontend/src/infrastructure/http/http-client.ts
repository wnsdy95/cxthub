 ...
 * Normalizes error model (including JSON envelope with code field) from sync protocol to HttpError.
 *
 * Responsibilities:
 ...
 * code: Machine-readable code from sync protocol (e.g., "diverged_forked", "integrity_violation").
 */
...
/** Common request handling: JSON serialization/deserialization + non-2xx → HttpError( Envelope Parsing). */
