...
redacted logs, and reproduction steps when asking for help. Never post access
tokens, database DSNs, private repository URLs, or agent transcripts.

Only the latest release and current `main` are actively supported. Maintainers
may close requests that cannot be reproduced, concern unsupported versions, or
