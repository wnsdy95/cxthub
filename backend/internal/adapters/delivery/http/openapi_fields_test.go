...
func TestOpenAPISchemaFieldDrift(t *testing.T) {
	...
	cases := []struct {
		...
		{"GitScanJob", reflect.TypeOf(domain.GitScanJob{})},
		{"GitScanPage", reflect.TypeOf(domain.GitScanPage{})},
		{"GitHeadScan", reflect.TypeOf(domain.GitHeadScan{})},
		...
		{"GitHubIdentity", reflect.TypeOf(domain.GitHubIdentity{})},
		{"GitHubInstallation", reflect.TypeOf(domain.GitHubInstallation{})},
		{"GitHubRepository", reflect.TypeOf(domain.GitHubRepository{})},
		{"GitHubBinding", reflect.TypeOf(domain.GitHubBinding{})},
		{"GitHubTeam", reflect.TypeOf(domain.GitHubTeam{})},
		{"GitHubTeamMapping", reflect.TypeOf(domain.GitHubTeamMapping{})},
		{"GitHubConnection", reflect.TypeOf(domain.GitHubConnection{})},
		{"GitHubOverview", reflect.TypeOf(app.GitHubOverview{})},
