...
func ValidateProductionStore(store any) error {
	...
	required := []struct {
		...
		{"workspace", supports[outbound.WorkspaceStore](store)},
		{"enterprise", supports[outbound.EnterpriseStore](store)},
		...
		{"workspace transactions", supports[outbound.WorkspaceTransactions](store)},
		{"workspace access locks", supports[outbound.WorkspaceAccessLocker](store)},
