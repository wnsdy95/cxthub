...
// Negotiate: want (server missing parts) = client haves \ server has (SYNC-PROTOCOL §3.2 step A).
...
// UpdateRef: Update the reference based on the current target and CAS (SYNC-PROTOCOL §5).
//
