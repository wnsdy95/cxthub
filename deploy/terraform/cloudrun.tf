...
#   move pairing state into the store as described in docs/DEPLOYMENT.md under Scaling path.
...
resource "google_cloud_run_v2_service" "cxtd" {
  ...
  template {
    ...
    containers {
      ...
      # Security settings (see docs/DEPLOYMENT.md, Environment variables): require Firebase
